...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '6982028767:AAHmZP9dKyVsks11aNV09WSLynx65UgA2jk'))
    name = str(getenv('name', 'Pikashow File2Link Bot'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://file2link:Surajrathod.878@cluster0.p0wdwif.mongodb.net/?retryWrites=true&w=majority'))
